               ...
               uint32_t pixelOrder)
{
    ...
    // only support 8-bit for right now
    if (srcAttr[NVM_SURF_ATTR_BITS_PER_COMPONENT].value == NVM_SURF_ATTR_BITS_PER_COMPONENT_8 &&
    ...
    Opencv_display(pDstBuff, dstWidth, dstHeight);
